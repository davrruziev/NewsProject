            ...
            <div class="container">
                <div class="basic-flex header__top">
                    ...
                    <div class="header__actions basic-flex">
                        ...
                        <div class="languages">
                            @if (\App::getLocale()=='ru')
                             <a href="#" class="btn language__option language__option--ru">РУ</a>
                ...
                <nav class="navbar">
                    ...
                    <ul class="navbar__menu basic-flex">
                        ...
                        <li class="menu__item"><a href="{{ route('categoryPost',$category->slug) }}">{{ $category['name_'.\App::getLocale()] }}</a></li>
                        @endforeach
                ...
                {{-- <a href="{{ $ad->url1 }}" class="advertisement-box" style="background-image:url(/site/images/ads/{{ $ad->img1 }})">
                    <h4>{{ $ad->title1 }}</h1>
                </a> --}}
            </div>
        </header>
